...
sealed interface AlbumsUiState {
    ...
    val smartCollections: List<SmartCollectionItem>

    data class Empty(
        override val showCreateDialog: Boolean = false,
        override val smartCollections: List<SmartCollectionItem> = SmartCollectionType.entries.map {
            SmartCollectionItem(type = it)
        },
    ) : AlbumsUiState
    data class Content(
