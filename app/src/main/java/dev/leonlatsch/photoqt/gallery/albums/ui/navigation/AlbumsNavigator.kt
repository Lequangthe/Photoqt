...
package dev.leonlatsch.photoqt.gallery.albums.ui.navigation

import androidx.navigation.NavController
import dev.leonlatsch.photoqt.gallery.albums.domain.model.SmartCollectionType
import dev.leonlatsch.photoqt.gallery.albums.ui.AlbumsFragmentDirections
...
class AlbumsNavigator @Inject constructor() {
    ...
    fun navigate(
        ...
        when (event) {
            ...
            is AlbumsNavigationEvent.OpenSmartCollection -> navController.navigate(
                AlbumsFragmentDirections.actionGlobalSmartCollectionFragment(
...
sealed interface AlbumsNavigationEvent {
    ...
    data class OpenSmartCollection(val type: SmartCollectionType) : AlbumsNavigationEvent
}