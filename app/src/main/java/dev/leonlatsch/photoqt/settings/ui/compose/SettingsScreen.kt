...
package dev.leonlatsch.photoqt.settings.ui.compose
...
import dev.leonlatsch.photoqt.BuildConfig
import dev.leonlatsch.photoqt.R
import dev.leonlatsch.photoqt.backup.domain.BackupStrategy
import dev.leonlatsch.photoqt.backup.ui.BackupBottomSheetDialogFragment
import dev.leonlatsch.photoqt.backup.ui.ConfirmPasswordDialog
import dev.leonlatsch.photoqt.databinding.BindingConverters
import dev.leonlatsch.photoqt.other.extensions.launchAndIgnoreTimer
import dev.leonlatsch.photoqt.other.extensions.show
import dev.leonlatsch.photoqt.other.openUrl
import dev.leonlatsch.photoqt.other.sendEmail
import dev.leonlatsch.photoqt.other.setAppDesign
import dev.leonlatsch.photoqt.settings.data.Config
import dev.leonlatsch.photoqt.settings.domain.Preference
import dev.leonlatsch.photoqt.settings.domain.PreferenceScreenConfig
import dev.leonlatsch.photoqt.settings.domain.PreferenceScreenConfigContent
import dev.leonlatsch.photoqt.settings.domain.PreferenceSection
import dev.leonlatsch.photoqt.settings.domain.models.SettingsEnum
import dev.leonlatsch.photoqt.settings.domain.models.SystemDesignEnum
import dev.leonlatsch.photoqt.settings.ui.SettingsFragment
import dev.leonlatsch.photoqt.settings.ui.changepassword.ChangePasswordDialog
import dev.leonlatsch.photoqt.settings.ui.hideapp.SecretLaunchCodeDialog
import dev.leonlatsch.photoqt.settings.ui.hideapp.ToggleAppVisibilityDialog
import dev.leonlatsch.photoqt.telemetry.ui.TelemetryExplanationSheet
import dev.leonlatsch.photoqt.ui.LocalFragment
