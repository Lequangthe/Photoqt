...
package dev.leonlatsch.photoqt.settings.domain

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import dev.leonlatsch.photoqt.R
import dev.leonlatsch.photoqt.settings.data.Config
import dev.leonlatsch.photoqt.settings.data.Config.Companion.GALLERY_START_PAGE
import dev.leonlatsch.photoqt.settings.data.Config.Companion.GALLERY_START_PAGE_DEFAULT
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SECURITY_ALLOW_SCREENSHOTS
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SECURITY_ALLOW_SCREENSHOTS_DEFAULT
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SECURITY_BIOMETRIC_AUTHENTICATION_ENABLED
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SECURITY_BIOMETRIC_AUTHENTICATION_ENABLED_DEFAULT
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SYSTEM_DESIGN
import dev.leonlatsch.photoqt.settings.data.Config.Companion.SYSTEM_DESIGN_DEFAULT
import dev.leonlatsch.photoqt.settings.domain.models.LockTimeout
import dev.leonlatsch.photoqt.settings.domain.models.SettingsEnum
import dev.leonlatsch.photoqt.settings.domain.models.StartPage
