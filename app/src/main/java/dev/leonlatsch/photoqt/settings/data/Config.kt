...
package dev.leonlatsch.photoqt.settings.data
...
import dev.leonlatsch.photoqt.telemetry.domain.TelemetryEnabledByDefault
...
class Config(context: Context) {
    ...
    companion object {
         ...
         */
        const val FILE_NAME = "dev.leonlatsch.photoqt_preferences"
