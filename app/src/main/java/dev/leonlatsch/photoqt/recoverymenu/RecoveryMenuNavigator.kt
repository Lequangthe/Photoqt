...
package dev.leonlatsch.photoqt.recoverymenu
...
class RecoveryMenuNavigator @Inject constructor() {
    ...
    fun navigate(navigationEvent: NavigationEvent, activity: AppCompatActivity) {
        when (navigationEvent) {
            NavigationEvent.OpenPhotoqt -> navigateOpenPhotoqt(activity)
    ...
    private fun navigateOpenPhotoqt(activity: AppCompatActivity) {
    ...
    sealed class NavigationEvent {
        object OpenPhotoqt : NavigationEvent()
