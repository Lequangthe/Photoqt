...
package com.quangthe.photoqt.settings.domain

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import com.quangthe.photoqt.R
import com.quangthe.photoqt.settings.data.Config
import com.quangthe.photoqt.settings.data.Config.Companion.GALLERY_START_PAGE
import com.quangthe.photoqt.settings.data.Config.Companion.GALLERY_START_PAGE_DEFAULT
import com.quangthe.photoqt.settings.data.Config.Companion.SECURITY_ALLOW_SCREENSHOTS
import com.quangthe.photoqt.settings.data.Config.Companion.SECURITY_ALLOW_SCREENSHOTS_DEFAULT
import com.quangthe.photoqt.settings.data.Config.Companion.SECURITY_BIOMETRIC_AUTHENTICATION_ENABLED
import com.quangthe.photoqt.settings.data.Config.Companion.SECURITY_BIOMETRIC_AUTHENTICATION_ENABLED_DEFAULT
import com.quangthe.photoqt.settings.data.Config.Companion.SYSTEM_DESIGN
import com.quangthe.photoqt.settings.data.Config.Companion.SYSTEM_DESIGN_DEFAULT
import com.quangthe.photoqt.settings.domain.models.LockTimeout
