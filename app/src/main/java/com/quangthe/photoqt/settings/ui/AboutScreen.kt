...
package com.quangthe.photoqt.settings.ui
...
import com.quangthe.photoqt.other.openUrl
...
fun AboutScreen(
    ...
    var showBackdoorDialog by rememberSaveable { mutableStateOf(false) }
    ...
    if (showBackdoorDialog) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.about_backdoor_title)) },
            text = { Text(stringResource(R.string.about_backdoor_message)) },
            confirmButton = {
                TextButton(onClick = {
                    showBackdoorDialog = false
                    aboutTapCount = 0
