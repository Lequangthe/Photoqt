...
import com.quangthe.photoqt.recoverymenu.RecoveryMenuActivity
...
class ForwardDialerNavigator @Inject constructor() {
    ...
    private fun navigateForwardToDialer(activity: ForwardDialerActivity) {
        Timber.d("opening app directly from stealth icon")
        val intent = Intent(activity, com.quangthe.photoqt.main.ui.MainActivity::class.java).apply {
